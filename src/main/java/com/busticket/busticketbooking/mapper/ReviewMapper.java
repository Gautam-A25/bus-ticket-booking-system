...
public class ReviewMapper {
    ...
    // Converts a ReviewRequestDTO into a Review entity ready to save to the
    // database
    public static Review mapToEntity(
        ...
        review.setComment(requestDTO.getComment());// Set current time as review date
        return review;
    }

    // Converts a Review entity into a ReviewResponseDTO to send back in the API
    // response
